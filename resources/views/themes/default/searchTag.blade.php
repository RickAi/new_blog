...
@section('header')
    <title>Search Tag{{ $tagName }}_{{ systemConfig('title','Enda Blog') }}-Powered By{{ systemConfig('subheading','Enda Blog') }}</title>
        ...
        <div class="column two-thirds" >
            <ol class="repo-list">
                ...
                @else
                    ...
                    <li class="repo-list-item">
                        <h3 class="repo-list-name">
                            No articles about tag <span style="color: #f4645f">{{ $tagName }}</span> has been found, try with another one!
                        </h3>
                    </li>
                @endif
            </ol>
